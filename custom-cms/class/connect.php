...
class connect{
	...
	function getdbSettings() {
		...
		$dbSettings['dbName']="news";
		$dbSettings['dbUser']="news";
		$dbSettings['dbPass']="a1b2c3";
	...
	function login($user,$pass) {
		...
		$result4 = mysql_query("select * from igwstudents where user='$user' and pass='$pass'"); 
        if (!$result4){
			$this->closeConnection();
			return false;}
