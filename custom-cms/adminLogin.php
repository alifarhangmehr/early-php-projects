...
<table width="960px" border="0" cellspacing="0" cellpadding="0" align="center" style="background:url(image/bg3.jpg) no-repeat">
  ...
  <tr>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="400px">
        <tr>
            <td width="160" height="24">نام کاربری</td>
            <td width="163" align="right"><label>
              <input type="text" name="user" id="user" />
            </label></td>
            <td width="77" align="right">&nbsp;</td>
        </tr>
        <tr>
            <td height="24">رمز عبور</td>
        ...
        <tr>
            <td colspan="3" align="center"><br /><input type="submit" id="adminLoginBut" value="ورود" /></td>
          </tr>
    </table>
    </form>
