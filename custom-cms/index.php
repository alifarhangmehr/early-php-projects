...
<script type="text/javascript" src="java/xinha/index/newsComment.js"></script>
...
<title>سایت علی فرهنگ مهر درس یار رسمی آی جی دبلیو</title>
</head>
<body>
	...
	*/
    ...
    //	echo 'خلاصه خبر : '.$row['newsBody'].'<br />';
		...
		*/
		...
		echo '</table>';
        echo '<tr><td width="110px"><img src= '.$row['image'].' /></td><td id="newsBriefTd" width="870px">'.$row['brief'].'<br /><br />
...
<div id="outreCommentsDiv">
    ...
    <div id="commentsPanelDiv"><img src="themes/default/images/closeComments.png" width="22" height="22" onclick="hideCommentsDiv()" /></div>
        <table width="600px" border="0" cellpadding="0" cellspacing="0" style="z-index:999">
        <tr>
...
<script type="text/javascript" language="javascript" src="http://www.webgozar.ir/c.aspx?Code=1926682&amp;t=counter" ></script>
<noscript><a href="http://www.webgozar.com/counter/stats.aspx?code=1926682" target="_blank">&#1570;&#1605;&#1575;&#1585;</a></noscript>
