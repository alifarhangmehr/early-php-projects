...
echo "<br />miladi date is $miladijoomfa .and shamsi date is $shamsijoomfa <br />";
...
echo "<br />shamsi date is $shamsijoomfa .and miladi date is $miladijoomfa <br />";

//Today date shamsi

echo "<br />today date miladi is ". date("Y/m/d") . " . and today date to shamsi is " . pdate("Y/m/d") . " . ";

echo "<br /><br /><a href=\"http://joomfa.org\" target=\"_blank\" >jalali,shamsi and persian date in joomfa</a>";  
