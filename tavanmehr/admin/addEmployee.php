...
<colgroup style="background:#CCC"></colgroup>
  ...
  <tr>
    <td width="154" align="right"><textarea name="address" cols="40" rows="6" id="address"></textarea></td>
  ...
  <tr>
    <td width="154" align="right"><input type="text" name="healthCardDeadline" id="healthCardDeadline" /></td>
