...
<title>افزودن ویزیت متخصص</title>
</head>
<body>
...
<?php
	...
	$query="SELECT MAX(specialistExaminationId) FROM specialistexamination";
	$result=$connector->queryRun($query);
	$row = mysql_fetch_array($result);
	//echo $row['MAX(foodCode)'];
	$specialistExaminationId=$row['MAX(specialistExaminationId)']+1;
	//echo '<br />specialistExaminationId:'.$specialistExaminationId.'<br />';
?>
<form method="post" action="addSpecialistExaminationP.php" enctype="multipart/form-data">
<div align="center">
<?php
...
<colgroup style="background:#CCC"></colgroup>
  ...
  <tr>
   ...
   <tr>
    <td width="250" align="right"><textarea name="examinationContext" cols="40" rows="6" id="examinationContext"></textarea></td>
