...
$healthCardDeadline=$_POST['healthCardDeadline'];
...
$query="INSERT INTO `tavanmehr`.`employee` (`employeeId`, `name`, `family`, `father`, `birthday`, `sex`, `marital`, `education`, `course`, `melliCode`, `shenasNo`, `shenasSerial`, `shenasSodur`, `postalCode`, `birthplace`, `emloymentDate`, `address`, `tel`, `mobile`, `bank`, `bankBranch`, `bankAccount`, `email`, `job`, `military`, `healthCardDeadline`, `photo1`, `photoSource`) VALUES ('$employeeId', '$name', '$family', '$father', '$birthday', '$sex', '$marital', '$education', '$course', '$melliCode', '$shenasNo', '$shenasSerial', '$shenasSodur', '$postalCode', '$birthplace', '$emloymentDate', '$address', '$tel', '$mobile', '$bank', '$bankBranch', '$bankAccount', '$email', '$job', '$military', '$healthCardDeadline', '$photo1', '$photoSource');";
