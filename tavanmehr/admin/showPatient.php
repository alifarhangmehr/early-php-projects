...
while($row = mysql_fetch_array($result))
  {
	...
	echo '<td align=center><form method="post" action="editPatient.php"><input type="hidden" name="patientId" id="patientId" value="'.$row['patientId'].'" /><input type="hidden" name="patientId" id="patientId" value="'.$row['patientId'].'" /><input type="image" src="../themes/default/images/editPatientIcon.png"style="border:hidden" /></td></form>';
	...
	echo '<td align=center><a style="color:yellow; font-size:25px" href=showPatientDetails.php?patientId='.$row['patientId'].'><img src="../themes/default/images/viewDetails.png" /></td>';
	echo '<td align=center><a style="color:yellow; font-size:25px" href=showMedicalRecords.php?patientId='.$row['patientId'].'><img src="../themes/default/images/showMedicalRecordsIcon.png" width="40px" height="40px" /></td>';
	echo '<td align=center><a style="color:yellow; font-size:25px" href=patientCurrentStatus.php?patientId='.$row['patientId'].'><img src="../themes/default/images/radarIcon.png" width="40px" height="40px" /></td>';
	echo '</tr>';
  }
...
<input type="hidden" id="hiddenDeletePatientId" name="hiddenDeletePatientId" />
 &nbsp;&nbsp;&nbsp;&nbsp; 
<input type="button" value="انصراف" onclick="hideDeletePatientDiv()" />
</form>
<br /><br />
</div>
</div>
