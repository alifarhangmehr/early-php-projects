...
$query="INSERT INTO patient (patientId, name, family, fatherName, birthday, nationalCode, disabilityCode, disabilityType, disabilityStartDate, caseNumber, homeAdress1, homeAdress2, phone1, phone2, mobile1, mobile2, photo1, photoSource, behavioralStatus, educationalStatus, ActionsTaken, economicSituation, StatusOfHomeVisits, comments1, comments2, comments3) VALUES ('$patientId','$name','$family','$fatherName','$birthday','$nationalCode','$disabilityCode','$disabilityType','$disabilityStartDate','$caseNumber','$homeAdress1','$homeAdress2', '$phone1','$phone2','$mobile1', '$mobile2','$photo1','$photoSource','$behavioralStatus','$educationalStatus','$ActionsTaken','$economicSituation','$StatusOfHomeVisits','$comments1','$comments2','$comments3')";
