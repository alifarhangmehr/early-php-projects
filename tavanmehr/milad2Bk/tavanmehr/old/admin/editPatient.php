...
<table align="center" width="600px" border="0">
  ...
  <tr>
    ...
    <td width="154" align="right"><input type="text" name="fatherName" value="'.$row['fatherName'].'" /></td>
  ...
  <tr>
    ...
    <td width="154" align="right"><input type="text" name="nationalCode" value="'.$row['nationalCode'].'" /></td>
  ...
  <tr>
    ...
    <td width="154" align="right"><input type="text" name="phone1" value="'.$row['phone1'].'" /></td>
    <td width="148" align="right">تلفن 1</td>
    
  </tr>
  <tr>
    
    <td width="154" align="right"><input type="text" name="phone2" value="'.$row['phone2'].'" /></td>
