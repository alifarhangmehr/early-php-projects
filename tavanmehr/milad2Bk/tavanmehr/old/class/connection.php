...
class connection{
	...
	function registerNew($user,$name,$family,$pass,$email,$phone,$mobile,$brief){
		...
		//echo $active." | ".$user." | ".$name." | ".$family." | ".$pass." | ".$email." | ".$rDateEN." | ".$eDateEN." | ".$rDateFA." | ".$eDateFA." | ".$phone." | ".$mobile." | ".$bankName." | ".$bankSerial." | ".$acLevel." | ".$group." | ".$brief." | ".$adminBrief." | "; 
		 ...
		 $query2="insert into users values 						                     ('$active','$user','$name','$family','$pass','$email','$rDateEN','$eDateEN','$rDateFA','$eDateFA','$phone','$mobile','$groupname','$brief','$adminBrief')";
	...
	function automaticRegister($user,$name,$family,$pass,$email,$phone,$mobile,$brief){
        if (!($this->dbConnect())) return false;
		$user = $this->check_input($user);
		...
		//echo "flag2";	
		if($this->registerNew($user,$name,$family,$pass,$email,$phone,$mobile,$brief)){
			    $this->closeConnection();
			    return true;}
			else{
				//echo 'error6';
