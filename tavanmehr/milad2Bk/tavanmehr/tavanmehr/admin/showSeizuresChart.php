...
<form method="post" action="patientVitalSignChart.php">
...
<?php
	...
	$query="SELECT * FROM seizureschart";
	$result=$connector->queryRun($query);
	$num_rows = mysql_num_rows($result);
	$numberOfSeizuresChartId=$num_rows;
	echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p align="right" style="color:royalblue">تعداد تشنج : '.$numberOfSeizuresChartId.'</p>';
...
$connector=new connection();
if(!$connector->dbConnect()) echo 'error 1';
$query = "SELECT * FROM seizureschart ORDER BY seizuresChartId ASC";
$result=$connector->queryRun($query);
$counter=0;
