...
if($_POST['patientId']!=''){
$query = "(SELECT * FROM PatientCurrentStatus WHERE patientId='$patientId' AND ward LIKE '%$search%' OR patientId='$patientId' AND room LIKE '%$search%' OR patientId='$patientId' AND bed LIKE '%$search%' OR patientId='$patientId' AND dateEN LIKE '%$search%' OR patientId='$patientId' AND dateFA LIKE '%$search%')";
}else{
$query = "(SELECT * FROM PatientCurrentStatus WHERE ward LIKE '%$search%' OR room LIKE '%$search%' OR bed LIKE '%$search%' OR dateEN LIKE '%$search%' OR dateFA LIKE '%$search%')";
}
