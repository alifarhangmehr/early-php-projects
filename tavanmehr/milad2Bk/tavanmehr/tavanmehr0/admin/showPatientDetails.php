...
<table align="center" width="600px" border="0">
  ...
  <tr>
    ...
    <td width="154" align="right">'.$row['fatherName'].'</td>
  ...
  <tr>
    ...
    <td width="154" align="right">'.$row['nationalCode'].'</td>
  ...
  <tr>
    ...
    <td width="154" align="right">'.$row['phone1'].'</td>
    <td width="148" align="right">تلفن 1</td>
    
  </tr>
  <tr>
    
    <td width="154" align="right">'.$row['phone2'].'</td>
