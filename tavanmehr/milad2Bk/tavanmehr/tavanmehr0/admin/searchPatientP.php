...
<?php
	...
	echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p align="right" style="color:#999999">تعداد مددجو : <font color="royalblue">'.$numberOfPatients.'</font></p>';
...
if(!$connector->dbConnect()) echo 'error 1';
$search=$_POST['search'];
$query = "(SELECT * FROM patient WHERE name LIKE '%$search%'OR family LIKE '%$search%' OR caseNumber LIKE '%$search%')";
