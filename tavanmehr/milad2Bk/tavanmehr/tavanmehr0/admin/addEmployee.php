...
<colgroup style="background:#CCC"></colgroup>
  ...
  <tr>
    <td width="154" align="right"><input type="text" name="fatherName" id="fatherName" /></td>
  ...
  <tr>
    <td width="154" align="right"><input type="text" name="nationalCode" id="nationalCode" /></td>
  ...
  <tr>
    ...
    <td width="148" align="right">نوع مددجو</td>
  ...
  <tr>
    <td width="154" align="right"><input type="text" name="phone1" id="phone1" /></td>
    <td width="148" align="right">تلفن 1</td>
    <td width="20" align="center">13</td>
  </tr>
  <tr>
    <td width="154" align="right"><input type="text" name="phone2" id="phone2" /></td>
