...
--
-- Host: localhost
-- Generation Time: Jul 09, 2011 at 08:06 AM
...
CREATE TABLE IF NOT EXISTS `employee` (
  `employeeId` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `name` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `family` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `father` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `birthday` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `sex` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `Marital` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `education` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `course` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `melliCode` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `shenasNo` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `shenasSerial` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `shenasSodur` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `postalCode` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `birthplace` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `emloymentDate` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  ...
  `bank` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `bankBranch` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `bankAccount` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `email` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `job` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `military` varchar(200) COLLATE utf8_persian_ci NOT NULL,
...
('3', 'حسن', 'حسنی', 'محمد', '3/2/1375', '09123456790', '333', 'ذهنی', '1376', '33213', 'کرج مهرشهر فاز 32', 'کرج مهرشهر فاز 32', '02162265245', '', '09123456789', '3333333333333', '../upload/thumb3.jpg', '../upload/source3.jpg', 'ثبمشسیمب شیب شسیمبتشمسیتب شستیب شسیمبنش سیبت شسیمبتشسمیبتش سمکیبتیبرو.در ظ.طوردظط ر ظدطر ظطدرو.دظط ریبس یبلدسیبدل .سیبتل سید لسیبتناثبمشسیمب شیب شسیمبتشمسیتب شستیب شسیمبنش سیبت شسیمبتشسمیبتش سمکیبتیبرو.در ظ.طوردظط ر ظدطر ظطدرو.دظط ریبس یبلدسیبدل .سیبتل سید لسیبتناثبمشسیمب شیب شسیمبتشمسیتب شستیب شسیمبنش سیبت شسیمبتشسمیبتش سمکیبتیبرو.در ظ.طوردظط ر ظدطر ظطدرو.دظط ریبس یبلدسیبدل .سیبتل سید لسیبتناثبمشسیمب شیب شسیمبتشمسیتب شستیب شسیمبنش سیبت شسیمبتشسمیبتش سمکیبتیبرو.در ظ.طوردظط ر ظدطر ظطدرو.دظط ریبس یبلدسیبدل .سیبتل سید لسیبتناثبمشسیمب شیب شسیمبتشمسیتب شستیب شسیمبنش سیبت شسیمبتشسمیبتش سمکیبتیبرو.در ظ.طوردظط ر ظدطر ظطدرو.دظط ریبس یبلدسیبدل .سیبتل سید لسیبتناثبمشسیمب شیب شسیمبتشمسیتب شستیب شسیمبنش سیبت شسیمبتشسمیبتش سمکیبتیبرو.در ظ.طوردظط ر ظدطر ظطدرو.دظط ریبس یبلدسیبدل .سیبتل سید لسیبتناثبمشسیمب شیب شسیمبتشمسیتب شستیب شسیمبنش سیبت شسیمبتشسمیبتش سمکیبتیبرو.در ظ.طوردظط ر ظدطر ظطدرو.دظط ریبس یبلدسیبدل .سیبتل سید لسیبتناثبمشسیمب شیب شسیمبتشمسیتب شستیب شسیمبنش سیبت شسیمبتشسمیبتش سمکیبتیبرو.در ظ.طوردظط ر ظدطر ظطدرو.دظط ریبس یبلدسیبدل .سیبتل سید لسیبتناثبمشسیمب شیب شسیمبتشمسیتب شستیب شسیمبنش سیبت شسیمبتشسمیبتش سمکیبتیبرو.در ظ.طوردظط ر ظدطر ظطدرو.دظط ریبس یبلدسیبدل .سیبتل سید لسیبتناثبمشسیمب شیب شسیمبتشمسیتب شستیب شسیمبنش سیبت شسیمبتشسمیبتش سمکیبتیبرو.در ظ.طوردظط ر ظدطر ظطدرو.دظط ریبس یبلدسیبدل .سیبتل سید لسیبتناثبمشسیمب شیب شسیمبتشمسیتب شستیب شسیمبنش سیبت شسیمبتشسمیبتش سمکیبتیبرو.در ظ.طوردظط ر ظدطر ظطدرو.دظط ریبس یبلدسیبدل .سیبتل سید لسیبتنا', '', '', '', '', '', '', ''),
...
('4', 'مهیار', 'ترابی', 'مهدی', '01/2/1380', '5465656565', '5464565', 'ذهنی', '02/05/1371', '4444', 'کرج مهر شهر', '', '456546546', '456456', '456546546546', '456456546546546', '../upload/thumb4.jpg', '../upload/source4.jpg', '', '', '', '', '', '', '', ''),
