...
<table width="250" border="0" cellspacing="0" cellpadding="0" dir="rtl" align="center" bgcolor="#EEEEEE">
  ...
  <tr>
    <td align="center"><br /><form method="post" action="searchSeizuresChart.php">
...
$connector=new connection();
if(!$connector->dbConnect()) echo 'error 1';
$query = "SELECT * FROM SeizuresChart WHERE patientId='$patientId' ORDER BY SeizuresChartId ASC";
$result=$connector->queryRun($query);
$counter=0;
