...
<form method="post" action="patientCurrentStatus.php">
...
<?php
	...
	$query="SELECT * FROM patientcurrentstatus";
	$result=$connector->queryRun($query);
	$num_rows = mysql_num_rows($result);
	$numberOfPatientCurrentStatusId=$num_rows;
	echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p align="right" style="color:royalblue">تعداد وضعیت های فعلی : '.$numberOfPatientCurrentStatusId.'</p>';
...
$connector=new connection();
if(!$connector->dbConnect()) echo 'error 1';
$query = "SELECT * FROM patientcurrentstatus ORDER BY patientCurrentStatusId ASC";
$result=$connector->queryRun($query);
$counter=0;
