...
$query="INSERT INTO patient (patientId, patientCode, name, family, father, birthday, birthplace, melliCode, shenasNo, shenasSerial, shenasSodur, disabilityCode, disabilityType, disabilityStartDate, caseNumber, homeAdress1, homeAdress2, postalCode, tel1, tel2, mobile1, mobile2, photo1, photoSource, behavioralStatus, educationalStatus, actionsTaken, economicSituation, statusOfHomeVisits, comments1, comments2, comments3) VALUES ('$patientId','$patientCode','$name','$family','$father','$birthday','$birthplace','$melliCode','$shenasNo','$shenasSerial','$shenasSodur','$disabilityCode','$disabilityType','$disabilityStartDate','$caseNumber','$homeAdress1','$homeAdress2','$postalCode', '$tel1','$tel2','$mobile1', '$mobile2','$photo1','$photoSource','$behavioralStatus','$educationalStatus','$actionsTaken','$economicSituation','$statusOfHomeVisits','$comments1','$comments2','$comments3')";
