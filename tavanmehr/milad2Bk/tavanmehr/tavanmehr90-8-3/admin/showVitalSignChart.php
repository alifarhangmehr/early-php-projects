...
<?php
	...
	$query="SELECT * FROM vitalsignchart";
	$result=$connector->queryRun($query);
	$num_rows = mysql_num_rows($result);
	$numberOfVitalsignchart=$num_rows;
	echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p align="right" style="color:royalblue">تعداد علائم حیاتی : '.$numberOfVitalsignchart.'</p>';
...
$connector=new connection();
if(!$connector->dbConnect()) echo 'error 1';
$query = "SELECT * FROM vitalsignchart ORDER BY vitalSignChartId ASC";
$result=$connector->queryRun($query);
$counter=0;
