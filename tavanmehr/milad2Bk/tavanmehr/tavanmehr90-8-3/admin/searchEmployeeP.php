...
<form method="post" action="addSpecialistExamination.php">
<div align="right" dir="rtl"><input type="image" src="../themes/default/images/addIcon.png" align="middle" style="border:none" /> اضافه نمودن</div>
<input type="hidden" name="patientId" id="patientId" value="<?php echo $patientId; ?>" />
<input type="hidden" name="condition" id="condition" value="1" /></form>
<br />
...
while($row = mysql_fetch_array($result))
  {
	...
	echo '<td align=center><form method="post" action="editEmployee.php"><input type="hidden" name="employeeId" id="employeeId" value="'.$row['employeeId'].'" /><input type="hidden" name="employeeId" id="employeeId" value="'.$row['employeeId'].'" /><input type="image" src="../themes/default/images/editPatientIcon.png"style="border:hidden" /></td></form>';
...
<br /><br />
<form method="post" action="deleteEemployee.php">
