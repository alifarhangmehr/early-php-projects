...
$query="INSERT INTO `tavanmehr`.`medicationorders` (`medicationOrdersId`, `patientId`, `medicalCommandDateEN`, `medicalCommandDateFA`, `medicalCommand`, `therapeeuticMeasuresDateEN`, `therapeeuticMeasuresDateFA`, `therapeeuticMeasures`) VALUES ('$medicationOrdersId', '$patientId', '$medicalCommandDateEN', '$medicalCommandDateFA', '$medicalCommand', '$therapeeuticMeasuresDateEN', '$therapeeuticMeasuresDateFA', '$therapeeuticMeasures');";
...
if(con!='') window.location = "patientMedicationOrders.php?patientId=<?php echo $patientId; ?>"
else
