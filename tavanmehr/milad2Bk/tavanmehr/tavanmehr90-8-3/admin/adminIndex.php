...
<tr>
  ...
  <td width="234" align="center"><form method="post" action="searchMedicine.php" >
  ...
  <td height="40"><form method="post" action="searchPatientP.php" >
                	<img src="../themes/default/images/search.png" align="middle" width="32" height="32" />
		<input type="text" name="search" class="field" size="15" />
                    <input type="submit" class="greenBut" id="newsSearchSubmitBut2" value="جستجو" />
                 </form></td>
<td height="40"><form method="post" action="searchEmployeeP.php" >
                	<img src="../themes/default/images/search.png" align="middle" width="32" height="32" />
		<input type="text" name="search" class="field" size="15" />
                    <input type="submit" class="greenBut" id="newsSearchSubmitBut2" value="جستجو" />
                 </form></td>
...
<td bgcolor="#444444"><a href="showMedicine.php" ><img src="../themes/default/images/drugIcon3.png" width="32" height="32" align="middle" />&nbsp;&nbsp;لیست داروها | <a href="addMedicine.php" style="color:#669900">اضافه</a></td>
  <td height="40" bgcolor="#444444"><a href="addPatient.php" ><img src="../themes/default/images/addPatient.png" width="32" height="32" align="middle" />&nbsp;&nbsp; افزودن مددجو</a></td>
  <td height="40" bgcolor="#444444"><a href="addEmployee.php" ><img src="../themes/default/images/addPatient.png" width="32" height="32" align="middle" />&nbsp;&nbsp; افزودن کارمند</a></td>
  </tr>
<tr><td></td>
  <td height="40"><a href="showPatient.php"><img src="../themes/default/images/list.png" width="32" height="32" align="middle" />&nbsp;&nbsp; نمایش مددجو</td>
  <td height="40"><a href="showEmployee.php" ><img src="../themes/default/images/list.png" width="32" height="32" align="middle" />&nbsp;&nbsp;نمایش کارمند</td>
  </tr>
<tr style="display:none"><td bgcolor="#444444"></td>
  <td width="226" height="40" bgcolor="#444444">&nbsp;</td>
  <td width="220" height="40" bgcolor="#444444">&nbsp;</td>
  </tr>
...
<tr  style="display:none" >
  <td height="40"><a href="showMedicalHistory.php"><img src="../themes/default/images/medicalHistoryIcon.png" width="32" height="32" align="middle" />&nbsp;&nbsp;شرح حال | <a href="addMedicalHistory.php" style="color:#669900">اضافه</a></td>
