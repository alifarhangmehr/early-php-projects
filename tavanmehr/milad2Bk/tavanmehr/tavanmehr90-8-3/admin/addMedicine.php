...
<?php
	...
	$query="SELECT MAX(medicineId) FROM medicine";
	$result=$connector->queryRun($query);
	$row = mysql_fetch_array($result);
	//echo $row['MAX(foodCode)'];
	$medicineId=$row['MAX(medicineId)']+1;
	//echo '<br />medicineId:'.$medicineId.'<br />';
	
?>



<form method="post" action="addMedicineP.php" enctype="multipart/form-data">
<div align="center">
<?php
...
<colgroup style="background:#CCC"></colgroup>
  ...
  <tr>
    <td width="154" align="right"><input type="text" name="medicineNameEN" id="medicineNameEN"/></td>
    <td width="148" align="right">نام دارو انگلیسی</td>
    <td width="20" align="center">1</td>
  </tr>
  <tr>
    <td width="154" align="right"><input type="text" name="medicineNameFA" id="medicineNameFA" /></td>
    <td width="148" align="right">نام دارو فارسی</td>
    <td width="20" align="center">2</td>
  </tr>
  <tr>
    <td width="154" align="right"><input type="text" name="drugDose" id="drugDose" /></td>
    <td width="148" align="right">دز دارو</td>
    <td width="20" align="center">3</td>
  </tr>
  <tr>
    <td width="154" align="right"><input type="text" name="medicineType" id="medicineType" /></td>
