...
<table width="500" border="1" align="center" >
  <tr>
    <td colspan="7">
    <form method="post" action="addBrandP.php" enctype="multipart/form-data">
<table align="center" width="100%" border="0">
<colgroup></colgroup>
<colgroup></colgroup>
<colgroup style="background:#CCC"></colgroup>	 	 	 	 	 	 	 	 
  <tr>
    <td width="343" align="right"><input type="text" name="brandName" id="brandName" /></td>
    <td width="101" align="right">نام برند</td>
    <td width="32" align="center">1</td>
  </tr>
  <tr>
    <td width="343" align="right"><input type="file" name="file" /></td>
    <td width="101" align="right">تصویر</td>
