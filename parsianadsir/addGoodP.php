...
$connector=new connection();
$query="INSERT INTO `parsianads`.`goods` (
`goodId` ,
`group` ,
`goodName` ,
`brand` ,
...
VALUES (
'$goodId', '$group', '$goodName', '$brand', '$purchaseLink', '$date', '$price', '$comments', '$photoSource', '$photoThumb'
)";
$result=$connector->queryRun($query);
...
<table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="2" align="center"><a href="addGood.php">بازگشت</a></td>
  </tr>
  <tr>
