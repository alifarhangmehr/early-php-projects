...
$query="UPDATE `parsianads`.`links` SET `linkName` = '$linkName',
`linkTarget` = '$linkTarget' WHERE `links`.`linkId` ='$linkId';
";
...
<table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="2" align="center"><a href="showLink.php">بازگشت</a></td>
  </tr>
  <tr>
