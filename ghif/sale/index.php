...
<table width="100%" border="0" cellspacing="0" cellpadding="0" dir="<?php echo $language_direction; ?>">
  <tr>
    <td align="center"><a href="showCashList.php"><img src="../themes/<?php echo $_SESSION['theme']; ?>/images/cashIcon4.png" width="128" height="128"><br /><?php echo $saleIndex_manage_cash; ?></a></td>
  ...
  <tr>
    <td align="center"><a href="showBackup.php"><img src="../themes/<?php echo $_SESSION['theme']; ?>/images/backupIcon1.png" width="128" height="128"><br /><?php echo $saleIndex_manage_backup; ?></a></td>
    <td align="center"><img src="../themes/<?php echo $_SESSION['theme']; ?>/images/chartIcon1.png" width="128" height="128"><br /><?php echo $saleIndex_chart; ?></td>
    <td align="center"><a href="showOa.php"><img src="../themes/<?php echo $_SESSION['theme']; ?>/images/userIcon1.png" width="128" height="128"><br /><?php echo $saleIndex_opponent_account; ?></a></td>
    ...
    <td align="center"><img src="../themes/<?php echo $_SESSION['theme']; ?>/images/cashIcon3.png" width="128" height="128"><br /><?php echo $saleIndex_roll_account; ?></td>
    <td align="center"><img src="../themes/<?php echo $_SESSION['theme']; ?>/images/orderIcon1.png" width="128" height="128"><br /><?php echo $saleIndex_manage_order; ?></td>
  </tr>
  <tr>
    <td align="center"><img src="../themes/<?php echo $_SESSION['theme']; ?>/images/ghifIcon1.png" width="128" height="128"></td>
    <td align="center"><img src="../themes/<?php echo $_SESSION['theme']; ?>/images/ghifIcon2.png" width="128" height="128"></td>
    <td align="center"><img src="../themes/<?php echo $_SESSION['theme']; ?>/images/ghifIcon4.png" width="128" height="128"></td>
    <td align="center"><img src="../themes/<?php echo $_SESSION['theme']; ?>/images/ghifIcon3.png" width="128" height="128"></td>
