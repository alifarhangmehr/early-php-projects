...
INSERT INTO `factorextra` (`factorExtraId`, `factorExtraName`, `priceType`, `price`, `default`) VALUES
(1, 'مالیات', 'percentage', '4', 'yes'),
(2, 'ارزش افزوده', 'percentage', '4', 'yes'),
(3, 'پیک', 'static', '15000', 'no');
...
CREATE TABLE IF NOT EXISTS `settings` (
  ...
  `guildId` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  ...
  `version` varchar(200) COLLATE utf8_persian_ci NOT NULL,
...
INSERT INTO `stores` (`storeId`, `storeName`, `defaultStore`) VALUES
(1, 'انبار اصلی', 'yes');
