...
<table border="0" align="center" width="50%" dir="<?php echo $language_direction; ?>" cellpadding="0" cellspacing="0" style="font-size:12px; color:#FFF">
  <tr>
    <td align="center"><a href="../sale/index.php"><img src="../themes/<?php echo $_SESSION['theme']; ?>/images/shopIcon1.png" width="32" height="32" border="0" /></a></td>
    <td align="center"><a href="../sale/index.php"><?php echo $word_for_sale; ?></a></td>
...
<table border="0" cellspacing="0" cellpadding="0" align="center" width="100%" style="color:#FFCC33; border:thin solid #FFF; padding:5px; font-size:12px">
  <tr>
    ...
    <td align="<?php echo $language_align; ?>" rowspan="4" bgcolor="#333333" width="2px" style="padding:5px"><a href="../images/employes/source<?php echo $_SESSION['adminId']; ?>.jpg"><img src="../images/employes/thumb<?php echo $_SESSION['adminId']; ?>.jpg"  style="border:hidden" /></a></td>
  </tr>
  <tr>
...
<p align="left"><?php echo $row1['version']; ?></p>
</div>
</div>
</div>	
