...
(function($){
    $.fn.autosugguest = function(config) {
	   ...
	   methodType: 'POST',
        ...
        $('<div class="ausu-suggestionsBox"><img src="../modules/ausu-autosuggest/images/arrow.png" /><ul></ul></div>').appendTo('.' + config.className);
		...
		$("." + config.className + " > input").keyup(function(event)
        {
           ...
           if (event.which != 39 && event.which != 37 && event.which != 38 && event.which != 40 && event.which != 18 && event.which != 9 ) {
