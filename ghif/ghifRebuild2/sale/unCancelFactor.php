...
$pageHeader->createPageHeader('unCancelFactor','l');
include('../language/'.$_SESSION['language'].'/'.$_SESSION['language'].'.php');
$table=new table();

$factorId=$_POST['hiddenUnCancelId'];
...
while($row=mysql_fetch_array($result1)){
	...
	$values[7]=$unCancelFactor_auto_add_comment;
...
if($result1 && $result2){
	...
	echo '<p align="center">'.$unCancelFactor_error_message.'</p>';
	echo '<p align="center"><a href="'.$_SERVER['HTTP_REFERER'].'">'.$unCancelFactor_back_link_message.'</a></p>';
}
?>