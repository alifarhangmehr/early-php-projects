...
$pageHeader->createPageHeader('editFactor','j');
...
<form method="post" action="editFactorP.php" id="factorForm">
<input type="hidden" name="factorId" id="factorId" value="<?php echo $factorId; ?>" />
<table border="0" cellspacing="3" cellpadding="0" align="center" dir="<?php echo $language_direction; ?>"  class="factorTable"   onkeypress="executeFunctionWithEnter(event,'edit')">
...
<?php
	...
	echo '<tr class="addTableTd">
		...
		<td><select name="paperType" id="paperType" onchange="changeEditFactorAction()">
    ...
    <td colspan="2" align="center"><input type="button" value="'.$addFactor_submit_value.'" class="addTableBut" onclick="addPurchaseInPage(\'edit\')" /></form></td></tr><tr><td colspan="2"><div id="myDiv">';
