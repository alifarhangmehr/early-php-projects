...
$pageHeader->createPageHeader('showCashList','m');
...
LEFT JOIN employes ON cash.reciverEmployeId = employes.employeId ORDER BY cashId DESC";
...
WHERE name LIKE '%$search%' OR family LIKE '%$search%' OR cashPrice LIKE '%$search%' ORDER BY cashId DESC";
}
$table=new table();
$limit=30;
