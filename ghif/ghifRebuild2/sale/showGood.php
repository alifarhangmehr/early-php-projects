...
$pageHeader->createPageHeader('showGood','a');
...
if($_SESSION['search']=='')
	...
	LEFT JOIN field3 ON goods.fieldId3 = field3.fieldId3 ORDER BY goodId DESC';
else
	$query="SELECT * FROM goods
	LEFT JOIN field1 ON goods.fieldId1 = field1.fieldId1
	LEFT JOIN field2 ON goods.fieldId2 = field2.fieldId2
	LEFT JOIN field3 ON goods.fieldId3 = field3.fieldId3
	WHERE goodName LIKE '%$search%' OR barcode LIKE '%$search%' ORDER BY goodId DESC";
