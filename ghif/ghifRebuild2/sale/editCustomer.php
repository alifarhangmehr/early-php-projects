...
$pageHeader->createPageHeader('editCustomer','L');
...
$updateField[10][0]='birthday';
$updateField[11][0]='membershipDate';
$updateField[12][0]='membershipDuration';
$updateField[13][0]='comments';
...
$updateField[10][1]=$_POST['birthday'];
$updateField[11][1]=$_POST['membershipDate'];
$updateField[12][1]=$_POST['membershipDuration'];
$updateField[13][1]=$_POST['comments'];
$tableName='customers';
...
$table->showEditTable($fieldName1,$fieldValue);	
	...
	<tr>
		...
		<td><input type="file" name="photoSource" id="photoSource" /></td>
	</tr>
    <tr>
