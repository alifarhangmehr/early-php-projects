...
$pageHeader->createPageHeader('showInventoryDetails','S');
...
if($_GET['goodId']!='') {
	...
	<input type="image" src="../themes/'.$_SESSION['theme'].'/images/detailIcon1.png" border="0" style="border:none" width="24px" height="24px" />
	</form>
	</td></tr>';}
echo '</table>
...
<table align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="right"><a href="changeInventory.php?goodId='.$goodId.'"><img src="../themes/'.$_SESSION['theme'].'/images/inventoryIcon2.png" width="48" height="48" style="border:hidden" />'.' '.$showInventoryDetails_change.'</a>
		</td>
	</tr>
	<tr>
		<td align="right"><a href="displacementStore.php?goodId='.$goodId.'"><img src="../themes/'.$_SESSION['theme'].'/images/inventoryIcon1.png" width="48" height="48" style="border:hidden" />'.' '.$showInventoryDetails_displacement.'</a>
		</td>
	</tr>
</table>';
?>