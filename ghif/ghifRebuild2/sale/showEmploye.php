...
$pageHeader->createPageHeader('showEmploye','A');
...
$fieldName3[0][1]=$showEmploye_employe_photo;
$fieldName3[1][1]=$showEmploye_acLevel;

if(isset($_GET['search']))$_SESSION['search']=$_GET['search'];
$search=$_SESSION['search'];
if($_SESSION['search']=='')
	$query='SELECT * FROM employes ORDER BY employeId DESC';
else
	$query="SELECT * FROM employes
	WHERE name LIKE '%$search%' OR family LIKE '%$search%' ORDER BY employeId DESC";
