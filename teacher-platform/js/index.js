...
function showNewsBody(serial){
	...
	//alert(document.getElementById('newsTitleTd'+serial).innerHTML);
...
function fontPlus(id){
	//alert('d');
	document.getElementById('newsBriefTd'+id).style.fontSize="20px";
}
...
function changeColor(id,colorCode){
	//alert(colorCode);
	//if(document.getElementById('newsBody').style.display="none")
