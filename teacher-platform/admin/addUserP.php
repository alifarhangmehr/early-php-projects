...
$query="select * from users where user='$user' or studentNumber='$studentNumber'";
$result=$connector->queryRun($query);
$num = mysql_num_rows($result);
if($num>=1){
	echo '<br><br><br><br><br><div align=center><font color=red>نام کاربری یاشماره کاربریی قبللاً ثبت شده  است</font><br><br><br><a href="addStudentForm.php">بازگشت به صفحه قبل</a></div>';
	exit;	
}
//end check not registered before

//add user
$query="INSERT INTO users (id, studentNumber, user, pass, groupName, name, family, pName, pFamily, certificateName, father, country, state, city, email, website, nationalCode, gender, single, birthday, birthPlace, education, interest, brief, registerDate, graduateDate, mobile1, mobile2, telephone, homeAddress, workAddress, photo1, photoSource, homePage, accessLevel) VALUES ('$id','$studentNumber', '$user', '$pass','$groupName','$name','$family','$pName','$pFamily','$certificateName','$father','$country','$state','$city','$email','$website','$nationalCode','$gender','$single','$birthday','$birthPlace','$education','$interest','$brief','$registerDate','$graduateDate','$mobile1','$mobile2','$telephone','$homeAddress','$workAddress','$photo1','$photoSource','$homePage','$accessLevel')";
$result=$connector->queryRun($query);
if($result){
	echo '<br><br><br><br><br><div align=center><font color=green>رکورد کاربری جدید با موفقیت ایجادشد</font><br><br><br><br><a href="addStudentForm.php">بازگشت به صفحه قبل</a><br><br><a href="showStudents.php">مشاهده لیست کاربران</a></div>';
}else{
