<?php
session_start();
$admin=$_SESSION['allowEnterAdminArea'];
	...
	<div id="panel">
		<div class="content clearfix">
			...
			<div class="left right">
                ...
                <br />
                <br />
                <a href="newsInsert.php" target="adminIframe"><img src="../themes/default/images/admin/editStdBoardNewsIcon.png" width="32" height="32" align="middle" />&nbsp;&nbsp; ویرایش اخبار بورد کاربران</a>
                <br />
                <br />
            	<a href="newsInsert.php" target="adminIframe"><img src="../themes/default/images/admin/stdCommentsIcon.png" width="32" height="32" align="middle" />&nbsp;&nbsp; نظرات کاربران</a>
                <br />
                <br />
                <a href="newsInsert.php" target="adminIframe"><img src="../themes/default/images/admin/deleteStdBoardNews.png" width="32" height="32" align="middle" />&nbsp;&nbsp; حذف خبر از بورد کاربران</a>
                <br />
                <br />
