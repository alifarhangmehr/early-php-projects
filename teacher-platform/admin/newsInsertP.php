...
$query = "INSERT INTO news (id,newsId,fullDate,dateEN,dateFA,newsTime,newsGroup,author,accessLevel,newsTitle,brief,newsBody,lastDateModified,lastDateENModified,lastDateFAModified,lastTimeModified,lastOneModified,photo1,photoSource) VALUES ('$id','$newsId','$fullDate','$dateEN','$dateFA','$newsTime','$newsGroup','$author','$accessLevel','$newsTitle','$brief','$newsBody','$lastDateModified','$lastDateENModified','$lastDateFAModified','$lastTimeModified','$lastOneModified','$photo1','$photoSource')";
...
echo $image ;
?>
<div align="center" ><a href="galleryShow.php">gallery</a></div>
