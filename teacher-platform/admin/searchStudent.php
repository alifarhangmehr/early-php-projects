...
<tr> 
	...
	<th style="color:#6C0">شماره کاربریی</th>
...
if($searchOP=='studentNumber') $query = "(SELECT * FROM  users WHERE studentNumber = '$searchValue')";

else if($searchOP=='user') $query = "(SELECT * FROM  users WHERE user = '$searchValue')";

else if($searchOP=='groupName') $query = "(SELECT * FROM  users WHERE groupName = '$searchValue')";

else if($searchOP=='name') $query = "(SELECT * FROM  users WHERE name = '$searchValue' or pName = '$searchValue')";

else if($searchOP=='family') $query = "(SELECT * FROM  users WHERE family = '$searchValue' or pFamily = '$searchValue')";

else if($searchOP=='father') $query = "(SELECT * FROM  users WHERE father = '$searchValue')";

else if($searchOP=='email') $query = "(SELECT * FROM  users WHERE email = '$searchValue')";

else if($searchOP=='nationalCode') $query = "(SELECT * FROM  users WHERE nationalCode = '$searchValue')";

else if($searchOP=='birthday') $query = "(SELECT * FROM  users WHERE birthday = '$searchValue')";

else if($searchOP=='telephone') $query = "(SELECT * FROM  users WHERE telephone = '$searchValue' OR mobile1 = '$searchValue' OR mobile2 = '$searchValue')";

else if($searchOP=='accessLevel') $query = "(SELECT * FROM  users WHERE accessLevel = '$searchOP')";
