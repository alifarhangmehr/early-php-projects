...
<div id="toppanel">
    ...
    <iframe id="adminIframe" name="adminIframe" src="board.php" width="100%" style="background:#000; border:none" frameborder="0"></iframe>
    </a></a>
...
//document.getElementById('adminIframe').height=screen.availHeight-screen.availHeight/22;
document.getElementById('adminIframe').height=returnSize()-returnSize()/10;
</script>
</body>
</html>