...
<colgroup style="background:#CCC"></colgroup> 
   ...
   <tr>
     <td width="154" align="right" bgcolor="#EAEAEA">
     <input name="companyName" type="text" id="companyName" companyName size="30" /></td>
  ...
  <tr>
    ...
    <tr>
      ...
      <td width="148" align="right" bgcolor="#EAEAEA">لوگو - ابعاد  150*290</td>
       ...
       <tr>
     <td width="154" align="right" bgcolor="#EAEAEA"><textarea name="uuid" cols="30" id="uuid"></textarea></td>
     <td width="148" align="right" bgcolor="#EAEAEA">uuid</td>
     </tr>
       <tr>
      <td width="154" align="right" bgcolor="#EAEAEA">
