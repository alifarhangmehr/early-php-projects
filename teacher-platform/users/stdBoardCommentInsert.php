...
$con=new connect();
$con-> dbConnect();
$query = "INSERT INTO usersboardcomments (newsId,cUser,cBody,cWebPage,cEmail,cReallEmail,cConfirm,cId,fullDate,dateEN,dateFA,cTime) VALUES ('$newsId','$cUser','$cBody','$cWebPage','$cEmail','$cReallEmail','$cConfirm','$cId','$fullDate','$dateEN','$dateFA','$cTime')";
