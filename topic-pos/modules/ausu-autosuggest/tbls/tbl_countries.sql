...
--
-- Table structure for table `tbl_goodName`
--

CREATE TABLE IF NOT EXISTS `tbl_goodName` (
...
--
-- Dumping data for table `tbl_goodName`
--

INSERT INTO `tbl_goodName` (`country_id`, `country_name`) VALUES
(1, 'Afghanistan'),
