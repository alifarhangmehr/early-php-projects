...
CREATE TABLE IF NOT EXISTS `cash` (
  ...
  `addToDeposit` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `comments` varchar(2500) COLLATE utf8_persian_ci NOT NULL,
  `accounting` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  PRIMARY KEY (`cashId`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;
...
CREATE TABLE IF NOT EXISTS `comparative` (
  `comparativeId` int(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `photoThumb` varchar(200) COLLATE utf8_persian_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `docdetails` (
  `docDetailId` int(20) NOT NULL,
  `documentId` int(20) NOT NULL,
  `comparativeId` int(20) NOT NULL,
  `scoreId` int(20) NOT NULL,
  `discribtion` varchar(2500) COLLATE utf8_persian_ci NOT NULL,
  `debt` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `credit` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  PRIMARY KEY (`docDetailId`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;
...
CREATE TABLE IF NOT EXISTS `employes` (
  ...
  `aAcLevel` longtext COLLATE utf8_persian_ci NOT NULL,
  `iAcLevel` longtext COLLATE utf8_persian_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `factor` (
  ...
  `oaId` int(20) NOT NULL,
  `accountId` int(20) NOT NULL,
  `factorNo` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `date` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `paymentType` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `barcode` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `type` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `accounting` varchar(200) COLLATE utf8_persian_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `goods` (
  ...
  `normalDiscount` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `userDiscount` varchar(200) COLLATE utf8_persian_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `inventory` (
  ...
  `stock` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `sellPrice` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `purchasePrice` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `date` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `comments` varchar(2500) COLLATE utf8_persian_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `barcode` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `goodName` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `factorBarcode` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `fieldId1` int(20) NOT NULL,
  `fieldId2` int(20) NOT NULL,
  `fieldId3` int(20) NOT NULL,
  `date` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `name` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `family` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `tel` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `status` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `deposit` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  `comments` varchar(1500) COLLATE utf8_persian_ci NOT NULL,
  PRIMARY KEY (`orderId`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;
...
CREATE TABLE IF NOT EXISTS `scores` (
  ...
  `fullCode` varchar(20) COLLATE utf8_persian_ci NOT NULL,
  `title` varchar(200) COLLATE utf8_persian_ci NOT NULL,
  PRIMARY KEY (`scoreId`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;
...
CREATE TABLE IF NOT EXISTS `shoutbox` (
  ...
  `user` varchar(25) COLLATE utf8_persian_ci NOT NULL DEFAULT 'anonimous',
