...
<p align="center" style="font-size:14px" align="right">
دانشجوی گرامی فرم زیر مستقیما در پرونده شما ذخیره میشود و نمامی مدارک و کارت های صادر شده با این اطلاعات تکمیل مشود بنابرین فرم را با نهایت دقت تکمیل کنید . با تشکر
</p>
<form name="addStudentForm" method="post" action="editDetailP.php" enctype="multipart/form-data">
